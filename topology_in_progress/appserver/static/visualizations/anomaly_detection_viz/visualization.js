define(["jquery","underscore","api/SplunkVisualizationBase","splunkjs/mvc","api/SplunkVisualizationUtils","views/Base","moment","models/search/Report","views/shared/alertcontrols/dialogs/saveas/Master","views/shared/alertcontrols/dialogs/edit/Master","backbone","splunkjs/mvc/sharedmodels","collections/shared/ModAlertActions","splunk.util","views/shared/Modal","views/shared/controls/ControlGroup","select2/select2","models/search/Alert"], function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_6__, __WEBPACK_EXTERNAL_MODULE_11__, __WEBPACK_EXTERNAL_MODULE_13__, __WEBPACK_EXTERNAL_MODULE_18__, __WEBPACK_EXTERNAL_MODULE_19__, __WEBPACK_EXTERNAL_MODULE_20__, __WEBPACK_EXTERNAL_MODULE_21__, __WEBPACK_EXTERNAL_MODULE_22__, __WEBPACK_EXTERNAL_MODULE_23__, __WEBPACK_EXTERNAL_MODULE_24__, __WEBPACK_EXTERNAL_MODULE_26__, __WEBPACK_EXTERNAL_MODULE_27__, __WEBPACK_EXTERNAL_MODULE_28__, __WEBPACK_EXTERNAL_MODULE_31__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/***/ (function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(2), __webpack_require__(3), __webpack_require__(4), __webpack_require__(10), __webpack_require__(16), __webpack_require__(5), __webpack_require__(9)], __WEBPACK_AMD_DEFINE_RESULT__ = function ($, _, SplunkVisualizationBase, DataHelper, ChartView, MasterDialog, mvc, SystemConfig) {
	    var tokens = {},
	    ...
	    return SplunkVisualizationBase.extend({
	        ...
	        formatData: function formatData(data, config) {
	            ...
	            if (_.isEmpty(results.series)) {
	                throw new SplunkVisualizationBase.VisualizationError('This visualization only supports numbers. Please fill null or check type.');
	            }
	            results.mode = mode;
	            return results;
	        },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2), __webpack_require__(1), __webpack_require__(5), __webpack_require__(3), __webpack_require__(6), __webpack_require__(7), __webpack_require__(9)], __WEBPACK_AMD_DEFINE_RESULT__ = function (_, $, mvc, SplunkVisualizationBase, SplunkVisualizationUtils, ZScore, SystemConfig) {
	    ...
	    var DataHelper = function () {
	        ...
	        _createClass(DataHelper, [{
	            key: 'isFieldValid',
	            value: function isFieldValid(fields) {
	                ...
	                if (!isDisplayFieldsValid) {
	                    throw new SplunkVisualizationBase.VisualizationError('For non-default detection algorithm, please convert fields name to "value_*", "outlier_*" where "value_*" indicates the value of field and "outlier_*" indicates whether it is outlier.');
	                }
	                if (!displayMode && (fields.indexOf('_time') < 0 || fields.indexOf('_span') < 0)) {
	                    throw new SplunkVisualizationBase.VisualizationError('This visualization requires timestamped, evenly spaced numeric time-series data. Try using the timechart command in your query.');
	                }
	                return true;
	            }
	        }, {
	            key: 'wrapDetectResults',
	            value: function wrapDetectResults(fields, columns, config, namespace) {
	                var results = {};
	            ...
	            key: 'wrapDisplayResults',
	            value: function wrapDisplayResults(fields, columns, config, namespace) {
	                var results = {};
	                var data = this._wrapPreparation(fields, columns, results);
	                if (_.isEmpty(data.columns)) {
	                    // not numerical
	            ...
	            key: 'wrapHighlightResults',
	            value: function wrapHighlightResults(fields, columns, config, namespace, time, field) {
	                var results = {};
	                var data = this._wrapPreparation(fields, columns, results);
	                if (_.isEmpty(data.columns)) {
	                    // not numerical
	            ...
	            key: '_getTrainTime',
	            value: function _getTrainTime(algorithm, span) {
	                var unit = 's';
	            ...
	            key: '_wrapSeries',
	            value: function _wrapSeries(data, outlier, trainCount, name, color, type, stack) {
	            ...
	            key: '_wrapPreparation',
	            value: function _wrapPreparation(fields, columns, results) {
	                var fields = this._getFields(fields);
	            ...
	            key: '_getFields',
	            value: function _getFields(fields) {
	            ...
	            key: '_getDetectedFields',
	            value: function _getDetectedFields(fields) {
	            ...
	            key: '_getData',
	            value: function _getData(columns, fields, detectedFields) {
	                var detectedData = {};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2), __webpack_require__(1), __webpack_require__(8)], __WEBPACK_AMD_DEFINE_RESULT__ = function (_, $, Config) {

	    var ZScore = function ZScore(strictness) {
	    ...
	    var instances = {};
	    return {
	        getInstance: function getInstance(strictness) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
	    return {
	        ...
	        NORMAL_COLORS: ['#d6563c', '#1e93c6', '#f2b827', '#6a5c9e', '#31a35f', '#3863a0', '#a2cc3e', '#ed8440', '#cc5068', '#73427f', '#11a88b', '#99712b', '#314d5b'],
	        ENABLE_MODE: 1,
	        DETECT_MODE: 2,
	        DISPLAY_MODE: 4,
	        HIGHLIGHT_MODE: 8,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2), __webpack_require__(1), __webpack_require__(11), __webpack_require__(12), __webpack_require__(9), __webpack_require__(14)], __WEBPACK_AMD_DEFINE_RESULT__ = function (_, $, BaseView, ChartParams, Config, Highcharts) {
	    var axisRelatedSelector = '.highcharts-grid, .highcharts-legend, .highcharts-axis, ' + '.highcharts-axis-labels.highcharts-yaxis-labels, .highcharts-axis-labels.highcharts-xaxis-labels, ' + '.highcharts-series-group';
	    return BaseView.extend({
	        ...
	        updateParams: function updateParams(config, namespace) {
	            // y title update
	        ...
	        updateSeries: function updateSeries(series, start, end, span) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(2), __webpack_require__(13)], __WEBPACK_AMD_DEFINE_RESULT__ = function ($, _, moment) {
	    return {
	        chart: {
	            animation: false,
	            height: 200
	        ...
	        tooltip: {
	            ...
	            formatter: function formatter() {
	                var template = _.template('<table>' + '<tr><td>_time</td><td align="right" width="75%"><%=time %></td></tr>' + '<tr><td style="color: <%=color %>"><%=name %></td><td align="right" width="75%"><%=value %></td></tr>' + '</table>');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(15)], __WEBPACK_AMD_DEFINE_RESULT__ = function ($, Highcharts) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2), __webpack_require__(21), __webpack_require__(11), __webpack_require__(25), __webpack_require__(29), __webpack_require__(17), __webpack_require__(30), __webpack_require__(31), __webpack_require__(24), __webpack_require__(9)], __WEBPACK_AMD_DEFINE_RESULT__ = function (_, Backbone, BaseView, JobView, InfoView, AlertView, JobModel, AlertModel, SplunkUtil, SystemConfig) {
	    ...
	    return BaseView.extend({
	        ...
	        setJobParams: function setJobParams(params, mode) {
	        ...
	        _saveJob: function _saveJob(mode) {
	            ...
	            var content = _.pick(this.models.input.toJSON(), SystemConfig.JOB_NAME, SystemConfig.JOB_PRIORITY, SystemConfig.JOB_SCHEDULE, SystemConfig.JOB_SEARCH, SystemConfig.JOB_TRAIN, SystemConfig.JOB_TAGS);
	            if ((mode & SystemConfig.EDIT_MODE) > 0) {
	                ...
	                $.when(this.models.job.createStanza(content)).then(function (jobId) {
	        ...
	        _showCreateAlert: function _showCreateAlert() {
	            ...
	            this.children.alert.showCreateAlert(this.models.input.get(SystemConfig.JOB_ID), this.models.input.get(SystemConfig.JOB_NAME), this.models.input.get(SystemConfig.JOB_SCHEDULE), this.models.input.get(SystemConfig.JOB_SEARCH), callback, this);
	        },
	        _showEditAlert: function _showEditAlert() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2), __webpack_require__(21), __webpack_require__(11), __webpack_require__(19), __webpack_require__(20), __webpack_require__(18), __webpack_require__(22), __webpack_require__(23), __webpack_require__(24), __webpack_require__(9)], __WEBPACK_AMD_DEFINE_RESULT__ = function (_, Backbone, BaseView, CreateAlertView, EditAlertView, ReportModel, SharedModels, ModAlertActionsCollection, SplunkUtil, SystemConfig) {
	    return BaseView.extend({
	        ...
	        showCreateAlert: function showCreateAlert(id, name, scheduleType, search, saveCallBack, context) {
	            ...
	            report.fetch({
	                ...
	                success: function (model, response) {
	                    report.entry.content.set('search', 'search index="' + SystemConfig.INDEX + '" sourcetype="' + SystemConfig.SOURCE_TYPE + '" ' + SystemConfig.JOB_ID + '="' + id + '" | eval total = 0 | ' + 'foreach outlier_* [eval outlier_count_<<MATCHSTR>> = if(<<FIELD>>=="True", 1, 0) ,' + ' total = total + outlier_count_<<MATCHSTR>>] ' + '| where total>0 | anomalytable | sort - Value | table _time, "Field name", Value, info_min_time, info_max_time');
	        ...
	        showEditAlert: function showEditAlert(alert, editCallBack, context) {
	        ...
	        setEarliestLatest: function setEarliestLatest() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2), __webpack_require__(1), __webpack_require__(21), __webpack_require__(26), __webpack_require__(27), __webpack_require__(9), __webpack_require__(28)], __WEBPACK_AMD_DEFINE_RESULT__ = function (_, $, Backbone, Modal, ControlGroup, SystemConfig) {
	    ...
	    return Modal.extend({
	        initialize: function initialize(options) {
	            ...
	            this.scheduleView = new ControlGroup({
	                ...
	                controlOptions: {
	                    ...
	                    model: this.models.input,
	                    items: [{ label: 'Run every hour', value: 'Hourly' }, { label: 'Run every day', value: 'Daily' }, { label: 'Run every week', value: 'Weekly' }, { label: 'Run every month', value: 'Monthly' }],
	                    save: false,
	                    toggleClassName: 'btn',
	            ...
	            this.severityView = new ControlGroup({
	                ...
	                controlOptions: {
	                    ...
	                    model: this.models.input,
	                    items: [{ label: 'Low', value: '1' }, { label: 'Medium', value: '2' }, { label: 'High', value: '3' }, { label: 'Critical', value: '4' }],
	                    save: false,
	                    toggleClassName: 'btn',
	                    labelPosition: 'outside',
	                    elastic: true,
	            ...
	            this.trainUnitView = new ControlGroup({
	                ...
	                controlOptions: {
	                    ...
	                    model: this.models.input,
	                    items: [{ label: 'seconds', value: 's' }, { label: 'minutes', value: 'm' }, { label: 'hours', value: 'h' }, { label: 'days', value: 'd' }],
	                    save: false,
	                    toggleClassName: 'btn',
	                    labelPosition: 'outside',
	                    elastic: true,
	        ...
	        events: $.extend({}, Modal.prototype.events, {
	            'click a.modal-btn-primary': function clickAModalBtnPrimary(e) {
	                e.preventDefault();
	                if (this._validateInput()) {
	                    this.models.input.set(SystemConfig.JOB_TRAIN, Math.abs(parseInt(this.models.input.get('trainNum'))) + this.models.input.get('trainUnit'));
	                    this.hide();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2), __webpack_require__(1), __webpack_require__(26), __webpack_require__(9)], __WEBPACK_AMD_DEFINE_RESULT__ = function (_, $, Modal, SystemConfig) {
	    var BUTTON_CANCEL = '<a href="#" class="btn cancel-job pull-left">Cancel</a>',
	        ...
	        BUTTON_CLASS = ['create-alert', 'edit-alert', 'delete-alert', 'create-job', 'edit-job', 'delete-job', 'change-job-mode'];
	    return Modal.extend({
	        initialize: function initialize(options) {
	            Modal.prototype.initialize.apply(this, arguments);
	        },
	        ...
	        events: $.extend({}, Modal.prototype.events, {
	            'click .cancel-job': function clickCancelJob(e) {
	                e.preventDefault();
	                this.hide();
	            },
	            'click a.create-alert': function clickACreateAlert(e) {
	                e.preventDefault();
	                this.hide();
	                this.trigger('createAlert', this.name);
	            },
	            'click a.edit-alert': function clickAEditAlert(e) {
	                e.preventDefault();
	                this.hide();
	                this.trigger('editAlert');
	            },
	            'click a.delete-alert': function clickADeleteAlert(e) {
	                e.preventDefault();
	                this.hide();
	                this.trigger('deleteAlert', this.id, this.alert, true);
	            },
	            'click a.delete-job': function clickADeleteJob(e) {
	                e.preventDefault();
	                this.hide();
	                this.trigger('deleteJob', this.id, this.alert);
	            },
	            'click a.edit-job': function clickAEditJob(e) {
	                e.preventDefault();
	                this.hide();
	                this.trigger('editJob', this.name);
	            },
	            'click .create-job': function clickCreateJob(e) {
	                e.preventDefault();
	                this.hide();
	                this.trigger('createJob');
	            },
	            'click .change-job-mode': function clickChangeJobMode(e) {
	                e.preventDefault();
	                this.hide();
	        ...
	        showFail: function showFail(object, operation) {
	            this._clean();
	        ...
	        showAlertLoadFail: function showAlertLoadFail(name) {
	            this._clean();
	        ...
	        showJobSaveSuccess: function showJobSaveSuccess(jobMode, alertMode) {
	            this._clean();
	        ...
	        showJobDeleteConfirm: function showJobDeleteConfirm(id, name, alert) {
	            this._clean();
	        ...
	        showAlertDeleteConfirm: function showAlertDeleteConfirm(id, name, alert) {
	            this._clean();
	            if (_.isEmpty(alert)) {
	        ...
	        showJobModeChangeConfirm: function showJobModeChangeConfirm(operation, id, name, mode) {
	            this._clean();
	        ...
	        showJobEditConfirm: function showJobEditConfirm(name) {
	            this._clean();
	            ...
	            this.$(Modal.BODY_SELECTOR).html('Another job (' + name + ') has been saved with same search. ' + '<br>Do you want to edit this job?');
	            this.name = name;
	            this.show();
	        },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(2), __webpack_require__(21), __webpack_require__(5), __webpack_require__(9)], __WEBPACK_AMD_DEFINE_RESULT__ = function ($, _, Backbone, mvc, SystemConfig) {
	    ...
	    return Backbone.Model.extend({
	        ...
	        fetchData: function fetchData() {
	            ...
	            var request = service.request('configs/conf-anomalyconfigs', 'GET', { fillcontents: 1 });
	        ...
	        getNameWithSearch: function getNameWithSearch(search) {
	        ...
	        getJobWithName: function getJobWithName(name) {
	            var configs = this.get('configs');
	            var keys = Object.keys(configs);
	            for (var i = 0; i < keys.length; i++) {
	                var curConfig = configs[keys[i]];
	        ...
	        createStanza: function createStanza(stanzaObj) {
	            var jobId = this._generateUUID();
	            var content = $.extend({ name: jobId }, stanzaObj);
	            var request = service.request('configs/conf-anomalyconfigs', 'POST', null, //query
	            content);
	        ...
	        updateStanza: function updateStanza(stanzaName, stanzaObj) {
	            var request = service.request('configs/conf-anomalyconfigs/' + stanzaName, 'POST', null, //query
	            stanzaObj);
	            var deferred = $.Deferred();
	            request.done(function (response) {
	                this.set('success', false);
	        ...
	        deleteStanza: function deleteStanza(stanzaName) {
	            var request = service.request('configs/conf-anomalyconfigs/' + stanzaName, 'DELETE');
	            var deferred = $.Deferred();
	            request.done(function (response) {
	                deferred.resolve();
	            }.bind(this));
